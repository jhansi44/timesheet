...
@section('css')
<link href="{{ config('app.url') . '/sbadmin/css/bootstrap/social.css' }}" rel="stylesheet"/>@endsection
@section('content')
<div class="row">
  <div class="col-lg-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <p>
          ...
          <button type="button" class="btn btn-primary btn-xs">Mini button</button><br/><br/>
          <button type="button" class="btn btn-primary btn-lg btn-block">Block level button</button>
        </p>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">Circle Icon Buttons with Font Awesome Icons</div>
      <div class="panel-body">
        ...
        <button type="button" class="btn btn-danger btn-circle"><i class="fa fa-heart"></i></button><br/><br/>
        ...
        <button type="button" class="btn btn-danger btn-circle btn-lg"><i class="fa fa-heart"></i></button><br/><br/>
  ...
  <div class="col-lg-6">
    <div class="panel panel-default">
      <div class="panel-heading">Outline Buttons with Smooth Transition</div>
      <div class="panel-body">
